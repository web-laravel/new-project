                                        ...
                                        <li>
                                            <figure>
                                                <a class="aa-product-img" href="#"><img width="250px" height="300px"
                                                                                        src="{{asset('lib\storage\app\avatar\\'.$pro->prod_img)}}"
                                                                                        alt="polo shirt img"></a>
                                                <a class="aa-add-card-btn" href="#"><span
                                                            class="fa fa-shopping-cart"></span>Thêm vào giỏ hàng</a>
                                                <figcaption>
                                                    <h4 class="aa-product-title"><a href="#">{{$pro->prod_name}}</a>
                                                    </h4>
                                                    <span class="aa-product-price">{{number_format($pro->prod_price,'0',',','.')}} VNĐ</span>
                                                </figcaption>
                                            </figure>
